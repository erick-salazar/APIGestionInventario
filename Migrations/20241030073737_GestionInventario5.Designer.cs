...
namespace APIGestionInventario.Migrations
{
    ...
    [Migration("20241030073737_GestionInventario5")]
    partial class GestionInventario5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 1, 37, 36, 82, DateTimeKind.Local).AddTicks(360),
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 1, 37, 36, 82, DateTimeKind.Local).AddTicks(377),
                            RolNombre = "Empleado"
                        });
                });
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 1, 37, 36, 82, DateTimeKind.Local).AddTicks(529),
                            Password = "@1234Abc",
                            RolId = 1,
