...
namespace APIGestionInventario.Migrations
{
    ...
    [Migration("20241030185602_APIGestionInventario5")]
    partial class APIGestionInventario5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 12, 55, 59, 847, DateTimeKind.Local).AddTicks(8106),
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 12, 55, 59, 847, DateTimeKind.Local).AddTicks(8127),
                            RolNombre = "Empleado"
                        });
                });
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 12, 55, 59, 847, DateTimeKind.Local).AddTicks(8497),
                            Password = "@1234Abc",
                            RolId = 1,
