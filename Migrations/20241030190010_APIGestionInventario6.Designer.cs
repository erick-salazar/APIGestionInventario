...
namespace APIGestionInventario.Migrations
{
    ...
    [Migration("20241030190010_APIGestionInventario6")]
    partial class APIGestionInventario6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 0, 8, 65, DateTimeKind.Local).AddTicks(9879),
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 0, 8, 65, DateTimeKind.Local).AddTicks(9901),
                            RolNombre = "Empleado"
                        });
                });
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 0, 8, 66, DateTimeKind.Local).AddTicks(216),
                            Password = "@1234Abc",
                            RolId = 1,
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 0, 8, 66, DateTimeKind.Local).AddTicks(225),
                            Password = "123Abc+",
                            RolId = 1,
