...
namespace APIGestionInventario.Migrations
{
    ...
    [Migration("20241030190211_APIGestionInventario7")]
    partial class APIGestionInventario7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 2, 9, 604, DateTimeKind.Local).AddTicks(4640),
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 2, 9, 604, DateTimeKind.Local).AddTicks(4654),
                            RolNombre = "Empleado"
                        });
                });
            ...
            modelBuilder.Entity("APIGestionInventario.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 2, 9, 604, DateTimeKind.Local).AddTicks(4885),
                            Password = "@1234Abc",
                            RolId = 1,
                        ...
                        new
                        {
                            ...
                            CreadoPor = "admin01",
                            Estado = false,
                            FechaCreado = new DateTime(2024, 10, 30, 13, 2, 9, 604, DateTimeKind.Local).AddTicks(4889),
                            Password = "123Abc+",
                            RolId = 2,
